...
import { AddIcon, CloseIcon } from '../../app/assets/icons'
        ...
        <div className={classes.paragraphBlock}>
          ...
          <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} defaultExpanded>
            <AccordionSummary
              ...
              id='panel1d-header'
              expandIcon={!expanded ? <AddIcon /> : <CloseIcon />}
            >
          ...
          <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} defaultExpanded>
            <AccordionSummary aria-controls='panel2d-content' id='panel2d-header' expandIcon={<AddIcon />}>
              <Typography variant='subtitle1'>1.05</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography variant='body1'>
                Проектирование и(или) иная деятельность, а также оказание консультационных и экспертных услуг в
                отношении сайтов или страниц сайтов в информационно-телекоммуникационной сети, включая
          ...
          <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} defaultExpanded>
            ...
            <AccordionDetails>
              <Typography variant='body1'>
                Реализация программ для ЭВМ (включая их обновления и изменения) любым способом и по любому виду
                договора, в том числе путем отчуждения прав, предоставления прав (лицензирования), предоставления
                удаленного доступа посредством информационно-телекоммуникационных сетей, включая Интернет.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} defaultExpanded>
            <AccordionSummary aria-controls='panel2d-content' id='panel2d-header' expandIcon={<AddIcon />}>
              <Typography variant='subtitle1'>4.01</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography variant='body1'>
                Комплексное обслуживание ИТ-инфраструктуры, организация удаленного доступа заказчика к
                ИТ-инфраструктуре, включая: администрирование прав доступа, учетной записи пользователей, аппаратной
                платформы ИТ-инфраструктуры, баз данных, систем мониторинга, выполнение системных настроек, получение
                обновлений, их установка и(или) сопровождение установки; обеспечение сетевой доступности; резервное
                копирование; выполнение плановых и внеплановых восстановлений; осуществление миграции (переноса) данных.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')} defaultExpanded>
            <AccordionSummary aria-controls='panel2d-content' id='panel2d-header' expandIcon={<AddIcon />}>
